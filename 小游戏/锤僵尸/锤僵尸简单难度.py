...
start_time = 5
part1 = [
    get_zombies(random.choice([普通僵尸, 路障僵尸]), random.randint(0, 4), random.randint(3,6),
                random.randint(1, 60)) for i in range(100)
]

part2 = [
    get_zombies(random.choice([普通僵尸, 路障僵尸, 铁桶僵尸]), random.randint(0, 4), random.randint(3,6),
                random.randint(1, 60)) for i in range(100)
]

part3 = [
    get_zombies(random.choice([普通僵尸, 路障僵尸, 铁桶僵尸, 读报僵尸]), random.randint(0, 4),
                random.randint(3,6), random.randint(1, 60)) for i in range(100)
]
big_wave1 = [
    get_zombies(random.choice([普通僵尸, 路障僵尸, 铁桶僵尸]), random.randint(0, 4), random.randint(3,6),
